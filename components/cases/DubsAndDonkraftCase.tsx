    ...
    <div className="flex h-screen bg-[#fbf7df] text-[#1b1b1b] font-sans overflow-hidden selection:bg-[#1b1b1b] selection:text-[#fbf7df]">
      ...
      <main className="flex-1 overflow-y-auto relative pt-16 md:pt-0">
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <footer className="px-16 py-8 border-t border-[#1b1b1b] bg-[#fbf7df] z-20 relative min-h-[250px]">
            <div className="grid grid-cols-3 w-full h-full items-start">
              ...
              <div className="flex flex-col justify-between h-full">
                ...
                <div className="flex flex-col gap-2">
                  <a href="https://www.linkedin.com/in/nikolaj-hoffmeister-3b50032a0/" target="_blank" rel="noopener noreferrer" className="text-sm font-bold uppercase tracking-widest text-[#1b1b1b] hover:text-[#1b1b1b]/70 flex items-center gap-2 transition-colors">
                    <span className="text-[#1b1b1b]">//</span> LinkedIn
                  </a>
                  <a href="https://www.instagram.com/hoffmeisterstudio/" target="_blank" rel="noopener noreferrer" className="text-sm font-bold uppercase tracking-widest text-[#1b1b1b] hover:text-[#1b1b1b]/70 flex items-center gap-2 transition-colors">
              ...
              <div className="flex flex-col justify-between h-full ml-auto">
                ...
                <div className="flex flex-col gap-1 items-start">
                  <a href="mailto:nikolaj@hoffmeisterstudio.com" className="text-sm font-bold uppercase tracking-widest text-[#1b1b1b] hover:text-[#1b1b1b]/70 hover:underline transition-colors flex flex-col items-start">
                    <span>nikolaj@</span>
                    <span>hoffmeisterstudio.com</span>
                  </a>
                  <a href="tel:+4551141562" className="text-sm font-bold uppercase tracking-widest text-[#1b1b1b] hover:text-[#1b1b1b]/70 hover:underline transition-colors">+45 51 14 15 62</a>
                </div>
              </div>
            </div>
          </footer>
